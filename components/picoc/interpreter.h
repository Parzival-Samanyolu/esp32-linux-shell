...
struct Value;   /* forward declaration (defined below) for the Intrinsic proto */
...
struct FuncDef {
    ...
    /* intrinsic call address or NULL. Given its real prototype here so GCC 15
     * (C23: "()" means zero args) accepts the 4-arg calls/assignments. */
